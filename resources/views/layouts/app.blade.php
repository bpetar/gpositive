...
<head>
    ...
    <title>{{ config('app.name', 'INSTITUT ZA POZITIVNU PSIHOLOGIJU') }}</title>
	
	<meta property="og:url"           content="https://institutpp.com" />
	<meta property="og:type"          content="website" />
	<meta property="og:title"         content="InstitutPP" />
	<meta property="fb:app_id"        content="1473373159728451" />
	<meta property="og:description"   content="Institut za pozitivnu psihologiju i savetovaliste" />
	<meta property="og:image"         content="https://institutpp.com/institutpp_og.png" />
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="app-navbar-collapse">
                    ...
                    <ul class="nav navbar-nav">
                        <li class="{{ Request::is('texts') ? 'active' : '' }}"><a class="djek" href="{{ url('/texts') }}">@lang('various.texts')</a></li>
                        <li class="{{ Request::is('programs') ? 'active' : '' }}"><a class="djek" href="{{ url('/programs') }}">@lang('various.programs')</a></li>
                        <li class="{{ Request::is('aboutus') ? 'active' : '' }}"><a class="djek" href="{{ url('/aboutus') }}">@lang('various.aboutus')</a></li>
